  ...
  return /* @__PURE__ */ jsxs(Modal, { title: step === "form" ? "Generate handover letter" : "Handover letter preview", onClose, width: "max-w-3xl", children: [
    ...
    step === "form" && /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4", children: [
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        availableTablets.length === 0 ? /* @__PURE__ */ jsx("p", { className: "rounded-md bg-amber-50 px-3 py-2 text-xs text-amber-700", children: 'No devices with status "In Stock". Use "Takeover device" first to bring devices into a warehouse.' }) : /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-2 max-h-72 overflow-y-auto pr-1", children: availableTablets.map((t) => {
  ...
  return /* @__PURE__ */ jsxs(Modal, { title: step === "form" ? "Generate replacement letter" : "Replacement letter preview", onClose, width: "max-w-3xl", children: [
    ...
    step === "form" && /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4", children: [
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        !hospitalId ? /* @__PURE__ */ jsx("p", { className: "text-xs text-slate-400", children: "Select a hospital first." }) : assignedAtHospital.length === 0 ? /* @__PURE__ */ jsx("p", { className: "rounded-md bg-amber-50 px-3 py-2 text-xs text-amber-700", children: "No devices are currently Assigned at this hospital." }) : /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-2 max-h-80 overflow-y-auto pr-1", children: assignedAtHospital.map((t) => {
